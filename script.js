...
function setupEventListeners() {
    ...
    if (helpBtn) {
        helpBtn.addEventListener('click', () => {
            showToast('info', 'Help & Support', 'Help and support features coming soon!');
        });
    }
...
function updateBudgetDisplay(value) {
    ...
    // Update the displayed value with BHD currency
    budgetValue.textContent = `${value} BHD per day`;
